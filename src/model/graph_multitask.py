...
class Model(ModelDesc, Config):
    def __init__(self, type_classification, nr_types, nr_classes, nuclei_type_dict, freeze=False):
        ...
        print('MODEL(GRAPH MULTITASK): Parameters Received,\n Type Classification: %s \n nr_types: %s \n nr_classes: %s \n nuclei_type_dict: %s' % (self.type_classification, self.nr_types, self.nr_classes, self.nuclei_type_dict))
